...
public class BlurDrawable{
    ...
    public BlurDrawable(Context context,Resources res, Bitmap bitmap,int sc) {
        array[0] = new BitmapDrawable(res,bitmap);
        array[1] = new BitmapDrawable(res,BitmapBlurHelper.doBlur(context,bitmap,sc,25));//生产模糊图片
        array[1].setAlpha(0);
